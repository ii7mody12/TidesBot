...
extensions = ['rewriteMusic', 'trivia', 'usermanagement', 'twitchAlert']
...
async def help(ctx):
    ...
    if not str(gr).replace("!help ", "").strip():
        ...
        embed.add_field(name="!help Trivia", value="Trivia commands. This module is WIP.", inline=False)
        ...
        if str(gr).lower() == "music":
            ...
            embed.add_field(name="!play x", value="Plays the link given, or searches youtube for whatever is typed.", inline=False)
        ...
        if str(gr).lower() == "user":
            ...
            embed.add_field(name="!addrole x", value="**Admin Only** Add a role that users can assign themselves to.", inline=False)
            embed.add_field(name="!removerole x", value="**Admin Only** Remove a role that users can assign themselves to.", inline=False)
            ...
            embed.add_field(name="!avatar @a @b @c...", value="Get the avatars of a user(s).", inline=False)
